...
def processModule(module, file=''):
    ...
    # don't import leaf modules with '_'
    if exclude_modules:
        for p in module.rsplit( '.', 1 ):
            if p[0] == '_':
                print 'modulename leaf begins with _'
                return
